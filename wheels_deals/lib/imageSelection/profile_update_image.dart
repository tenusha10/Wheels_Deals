...
class ProfileUpdateImage extends StatefulWidget {
  final String initialUrl;
  final Function(String imageUrl) onFileChanged;
  ProfileUpdateImage({this.onFileChanged, this.initialUrl});

  @override
  State<ProfileUpdateImage> createState() => _ProfileUpdateImageState();
}

class _ProfileUpdateImageState extends State<ProfileUpdateImage> {
  @override
  void initState() {
